...
import { setFontFamily, setParagraph, setHeading, setAlign, wrapBulletList, wrapOrderedList, insertLink, insertImage, setFontSize } from "./toolbar_commands";
import { ToolbarDropdownWithLabels, ToolbarDropdown } from "./toolbar_components";
import { FONT_OPTIONS, HEADER_OPTIONS, FONT_SIZES, ALIGN_ICON_MAP } from "./toolbar_options";
import { getCurrentFontSize, getCurrentAlignment, getCurrentListType } from "./toolbar_utils";
...
export const toolbarDropdowns: {
    ...
    createDropdowns() {
        ...
        this.fontFamilyDropdown = <ToolbarDropdownWithLabels
            icon=""
            title={(() => {
    ...
    this.headerDropdown = 
          ...
          />;
    this.fontSizeDropdown = <ToolbarDropdownWithLabels
            icon=""
            title={(() => {
              const size =
          ...
          />;
    this.alignmentDropdown = <ToolbarDropdown
            icon={
              ALIGN_ICON_MAP[
                editorStateAccessor && editorStateAccessor()
          ...
          />;
    this.listDropdown = <ToolbarDropdown
            icon={(() => {
              if (editorStateAccessor && editorStateAccessor()) {
          ...
          />;
    this.insertDropdown = <ToolbarDropdown
        icon="bi-plus-lg"
        options={[
          {
            label: "Insert Link",
